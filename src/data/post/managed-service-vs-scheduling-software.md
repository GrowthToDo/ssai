...
2. **Draft delivery.** Within 48 hours, three complete schedule drafts are delivered: one balanced, one fairness-optimized, and one cost-optimized. The manager reviews them and selects one.
